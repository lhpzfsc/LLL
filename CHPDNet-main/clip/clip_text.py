class_names = ['corrosion', 'crack', 'dent', 'lose','paint_fall', 'scratch',
                   ]

new_class_names = ['corrosion', 'crack', 'dent', 'lose','paint_fall', 'scratch',
                   ]

# class_names = ['c_color', 'l_color', 't_crack', 'w_color',    'g_bent',
#                'c_cut',   'l_cut',   't_glue',  'w_combined', 'g_broken',
#                'c_hole',  'l_fold',  't_gray',  'w_hole',     'g_glue',
#                'c_metal', 'l_glue',
#                't_oil',   'w_liquid',   'g_metal',
#                'c_thread','l_poke',  't_rough', 'w_scratch',  'g_thread',
#                    ]
#
# new_class_names = ['c_color', 'l_color', 't_crack', 'w_color',    'g_bent',
#                'c_cut',   'l_cut',   't_glue',  'w_combined', 'g_broken',
#                'c_hole',  'l_fold',  't_gray',  'w_hole',     'g_glue',
#                'c_metal', 'l_glue',  't_oil',   'w_liquid',   'g_metal',
#                'c_thread','l_poke',  't_rough', 'w_scratch',  'g_thread',
#                    ]
